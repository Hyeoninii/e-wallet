    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          ...
          {/* 동적 다중 서명 지갑 생성 카드 */}
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow cursor-pointer" onClick={() => navigate('/multisig/create-dynamic')}>
            <div className="flex items-center mb-4">
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900">동적 다중 서명</h3>
                <p className="text-sm text-gray-500">사용자 정의 권한과 정책</p>
              </div>
            </div>
            <p className="text-gray-600 text-sm">
              권한과 정책을 직접 정의하여 동적으로 컨트랙트를 생성합니다.
            </p>
        ...
        {(savedWallets.length > 0 || savedMultiSigWallets?.length > 0) && (
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              {savedMultiSigWallets?.map((mw) => (
                <div
                  key={mw.address}
                  onClick={() => navigate(`/multisig/${mw.address}`)}
                ...
                >
                  <div className="flex items-center mb-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="font-medium text-gray-900 truncate">{mw.name || '다중서명 지갑'}</div>
                      <div className="text-xs text-gray-500 font-mono">
                        {mw.address.slice(0, 6)}...{mw.address.slice(-4)}
                      </div>
                    </div>
                  </div>
                  <div className="flex items-center justify-between">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      />
                      {/* 필요 시 토글로 평문 표시를 원하면 Recover 페이지처럼 구현 가능 */}
                    </div>
                    <p className="text-xs text-gray-500 mt-1">
